...
namespace Perks\Tests\Mooc\CoursesCounter\Application\Increment;

use Perks\Mooc\CoursesCounter\Application\Increment\CoursesCounterIncrementer;
use Perks\Mooc\CoursesCounter\Application\Increment\IncrementCoursesCounterOnCourseCreated;
use Perks\Tests\Mooc\Courses\Domain\CourseCreatedDomainEventMother;
use Perks\Tests\Mooc\Courses\Domain\CourseIdMother;
use Perks\Tests\Mooc\CoursesCounter\CoursesCounterModuleUnitTestCase;
use Perks\Tests\Mooc\CoursesCounter\Domain\CoursesCounterIncrementedDomainEventMother;
use Perks\Tests\Mooc\CoursesCounter\Domain\CoursesCounterMother;
