...
test:
	@docker exec perks-php_ddd_skeleton-php make run-tests
...
ping-mysql:
	@docker exec perks-php_ddd_skeleton-mysql mysqladmin --user=root --password= --host "127.0.0.1" ping --silent
